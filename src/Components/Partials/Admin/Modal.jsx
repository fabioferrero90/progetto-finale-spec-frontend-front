...
const Modal = ({ type, product, closeModal }) => {
    ...
    const { isUsingAPI, addNotification, deleteProduct, updateProduct } = useGlobalContext()
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        {Object.entries(editedProduct).map(([key, value]) => {
                                            if (["id", "createdAt", "updatedAt", "rating", "reviews", "image", "parsed", "title", "description"].includes(key)) {
                                                return null;
                                            }
